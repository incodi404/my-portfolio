    ...
    <div className="w-full flex flex-row justify-center items-center">
      <div className="w-[90vw] flex flex-col justify-center items-center space-y-10">
        ...
        <div className="w-full flex justify-around flex-col xl:flex-row items-center gap-10">
          ...
          <section className="w-[20rem] sm:w-[35rem] h-auto sm:h-[34rem] p-10 text-left bg-[#222222] space-y-7 rounded-xl">
            ...
            <ul className="opacity-60 space-y-1">
              ...
              <li className="border-b-[1px] py-2">
                Implement monitoring tools to track performance and detect
                issues.
              </li>
              <li>
                Have a plan for rolling back to previous versions if issues
                arise.
              </li>
            </ul>
          </section>
        ...
        <div className="flex gap-5 flex-wrap justify-center items-center">
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Linux</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">JWT</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Cloudinary</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Passport.js</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">OAuth 2.0</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Multer</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Bootstrap</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Ionic</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Render</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Web Security</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Burpsuit</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">React Hook Form</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Axios</section>
          <section className="bg-[#222222] px-4 py-2 cursor-pointer hover:bg-sky-600">Nodemailer</section>
        </div>
          ...
          <div className="flex gap-10 items-center justify-center bg-[#222222] p-10 rounded-2xl flex-col xl:flex-row">
            ...
            <div className="text-left w-[30rem] space-y-5">
              <h3 className="text-[30px] font-bold flex justify-between items-center w-[30rem]">
                Rentify{" "}
                <span className="text-[20px] opacity-75">May, 2024</span>
              </h3>
              <p>
              ...
              <div className="flex flex-wrap gap-3">
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">Node JS</section>
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">Express JS</section>
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">React JS</section>
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">
                  MongoDB
                </section>
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">Redis</section>
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">Vercel</section>
                <section className="bg-[#414141] px-4 py-2 cursor-pointer hover:bg-sky-600">Render</section>
              </div>
              <div className="flex gap-5">
                <a href=""><button className="px-5 py-2 rounded-lg bg-black flex items-center gap-2">Github <FaGithub/></button></a>
                <a href="https://rentify-beige.vercel.app/" target="_blank"><button className="px-5 py-2 rounded-lg bg-sky-600" >Live</button></a>
              </div>
            </div>
          </div>
        </div>
